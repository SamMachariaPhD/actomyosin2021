...
INTEGER(KIND = Range15), PARAMETER :: NumTimeStep = 6E6, TimeStepEquil = 1E9, MaxNumMotors = 1E6, TimeForceON = 0

INTEGER, PARAMETER :: MaxAreaNum = NumTimeStep/AreaRenewDiv + 1

REAL(KIND = DP), PARAMETER :: 	pi = 3.14159265358979_DP, &
				kBT = 0.0042_DP, & ! was 0.0041 - 0.0042 for the correct* temp [Sam-Walcott-2012]
				dt=5.0E-7_DP, &
				Tol=1.0E-6_DP, &
				BondLength=0.25_DP, &
...
INTEGER, PARAMETER ::		OutPutDiv2=OutPutDiv !0.0005/dt
