...
plt.savefig(results_dir+'/'+'tipXY.png', format='png', dpi=300, bbox_inches='tight')
#===================================================================================================
...
xHead01 = np.linspace(0,spdHead01.shape[0], spdHead01.shape[0])
...
xTail01 = np.linspace(0,spdTail01.shape[0], spdTail01.shape[0])
#===================================================================================================
...
#plt.savefig(results_dir+'/'+'inst.svg', format='svg', dpi=3000, bbox_inches='tight')
plt.savefig(results_dir+'/'+'inst.png', format='png', dpi=300, bbox_inches='tight')
#===================================================================================================
...
plt.grid(color='gray', which='both', linestyle=':', linewidth=0.25)
#plt.savefig(results_dir+'/'+'xyTraj.svg', format='svg', dpi=3000, bbox_inches='tight')
plt.savefig(results_dir+'/'+'xyTraj.png', format='png', dpi=300, bbox_inches='tight')
#===================================================================================================
...
ax[0,1].hist(bmAc['bm'].T,30,density=True, alpha=1, histtype='bar', ec='black', color='green') # change 'normed' to 'density'
...
#ax[1,1].hist(bminAc['bm'].T,30,density=True, alpha=1, histtype='bar', ec='black', color='blue')
...
#plt.savefig(results_dir+'/'+'Mbding.svg', format='svg', dpi=3000, bbox_inches='tight')
plt.savefig(results_dir+'/'+'Mbding.png', format='png', dpi=300, bbox_inches='tight')
#===================================================================================================
v = avSpdHead01
dt = dt01
...
plt.legend(loc='best')
plt.savefig(results_dir+'/'+'allPersistence.svg',bbox_inches='tight', format='svg',dpi=300)
plt.close()
#===================================================================================================
...
plt.xlabel(r'$S (\mu m)$'); plt.ylabel(r'$<\cos \Delta \Theta >$')
plt.legend(loc='best')
plt.savefig(results_dir+'/'+'curveFit1_10th.svg',bbox_inches='tight', format='svg',dpi=300)
plt.close()
#===================================================================================================
# Curve fitting including correlation 1
...
plt.xlabel(r'$S (\mu m)$'); plt.ylabel(r'$<\cos \Delta \Theta >$')
plt.legend(loc='best')
plt.savefig(results_dir+'/'+'curveFit1_20th.svg',bbox_inches='tight', format='svg',dpi=300)
plt.close()
#===================================================================================================
...
plt.xlabel(r'$S (\mu m)$'); plt.ylabel(r'$<\cos \Delta \Theta >$')
plt.legend(loc='best')
plt.savefig(results_dir+'/'+'curveFit2_10th.svg',bbox_inches='tight', format='svg',dpi=300)
plt.close()
#===================================================================================================
# Curve fitting including correlation 2
...
plt.xlabel(r'$S (\mu m)$'); plt.ylabel(r'$<\cos \Delta \Theta >$')
plt.legend(loc='best')
plt.savefig(results_dir+'/'+'curveFit2_20th.svg',bbox_inches='tight', format='svg',dpi=300)
plt.close()
