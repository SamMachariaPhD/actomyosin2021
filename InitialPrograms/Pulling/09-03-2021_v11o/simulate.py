...
files = ['MotilityAssayActin2MotorsParameters_v06b.f90', 'mt.f90', 'MotilityAssayActin2MotorsConfinements_v02b.f90', 'MotilityAssayActin2MotorsForce_v01a.f90', 'MotilityAssayActin2MotorsFunc_v01k.f90', 'MotilityAssayActin2MotorsOutput_v01d.f90', 'MotilityAssayActin2MotorsMain_v011o.f90', 'analysis.py', 'film1.py', 'film2.py', 'tar.py', 'untar.py']

param_file = "MotilityAssayActin2MotorsParameters_v06b.f90"
...
while simulation_runs > 0:
    ...
    subprocess.call("ifort MotilityAssayActin2MotorsParameters_v06b.f90 mt.f90 MotilityAssayActin2MotorsConfinements_v02b.f90 MotilityAssayActin2MotorsForce_v01a.f90 MotilityAssayActin2MotorsFunc_v01k.f90 MotilityAssayActin2MotorsOutput_v01d.f90 MotilityAssayActin2MotorsMain_v011o.f90", shell=True)
